...
public sealed class ResilienceOptions
{
    ...
    public double InitialDelayMs { get; set; } = 250;

    public double MaxDelayMs { get; set; } = 2_000;
...
public sealed class PostgresOptions
{
    ...
    public string JobsTableName { get; set; } = "rag_ingestion_jobs";
